# module/dc_reactor — dc_reactor verb (group: nuclear)
...
The primary spec is [`datacenter-reactor.md`](datacenter-reactor.md), a verbatim extraction
...
| selftest | sentinel only (`module/dc_reactor/` directory present) |

To wire this verb: add `verify_dc_reactor.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `datacenter-reactor.md`, register the call from
