# module/thermal — thermal verb (group: thermal)
...
- **Primary spec**: [`thermal-management.md`](thermal-management.md)
- **Upstream**: `n6-architecture/domains/energy/thermal-management/` @ `c0f1f570` (extracted 2026-05-06)

## What's in this module

The primary spec is [`thermal-management.md`](thermal-management.md), a verbatim extraction
...
| selftest | sentinel only (`module/thermal/` directory present) |

To wire this verb: add `verify_thermal.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `thermal-management.md`, register the call from
