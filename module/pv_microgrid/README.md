# module/pv_microgrid — pv_microgrid verb (group: grid)
...
The primary spec is [`rooftop-pv-2nd-life-microgrid.md`](rooftop-pv-2nd-life-microgrid.md), a verbatim extraction
...
| selftest | sentinel only (`module/pv_microgrid/` directory present) |

To wire this verb: add `verify_pv_microgrid.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `rooftop-pv-2nd-life-microgrid.md`, register the call from
