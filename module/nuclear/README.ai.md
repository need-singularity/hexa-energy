# module/nuclear — AI-native handoff
...
3. **Group membership is contractual** (own 2). `nuclear` belongs to group
...
| Task | Where |
|---|---|
| Read the spec | [`nuclear-reactor.md`](nuclear-reactor.md) |
| Tweak a number | First update `../../core/energy/domain.md`, then mirror here |
| Wire this verb | Add `verify_nuclear.{hexa,py}`, register from `../../verify/energy_verify.py`, propagate wired count to spec.md/hexa.toml/cli |
...
Extracted from `n6-architecture/domains/energy/nuclear-reactor/` on 2026-05-06
(SHA `c0f1f570`). Moved from repo root into `module/nuclear/` on 2026-05-07
