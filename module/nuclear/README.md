# module/nuclear — nuclear verb (group: nuclear)
...
- **Primary spec**: [`nuclear-reactor.md`](nuclear-reactor.md)
- **Upstream**: `n6-architecture/domains/energy/nuclear-reactor/` @ `c0f1f570` (extracted 2026-05-06)

## What's in this module

The primary spec is [`nuclear-reactor.md`](nuclear-reactor.md), a verbatim extraction
...
| selftest | sentinel only (`module/nuclear/` directory present) |

To wire this verb: add `verify_nuclear.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `nuclear-reactor.md`, register the call from
