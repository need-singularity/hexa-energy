# module/efficiency — efficiency verb (group: meta)
...
The primary spec is [`energy-efficiency.md`](energy-efficiency.md), a verbatim extraction
...
| selftest | sentinel only (`module/efficiency/` directory present) |

To wire this verb: add `verify_efficiency.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `energy-efficiency.md`, register the call from
