# module/battery_arch — battery_arch verb (group: battery)
...
- **Primary spec**: [`battery-architecture.md`](battery-architecture.md)
- **Upstream**: `n6-architecture/domains/energy/battery-architecture/` @ `c0f1f570` (extracted 2026-05-06)

## What's in this module

The primary spec is [`battery-architecture.md`](battery-architecture.md), a verbatim extraction
...
This verb is one of 2 verbs in the battery group.
...
| selftest | sentinel only (`module/battery_arch/` directory present) |

To wire this verb: add `verify_battery_arch.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `battery-architecture.md`, register the call from
