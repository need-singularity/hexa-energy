# module/mineshaft — mineshaft verb (group: mining)
...
The primary spec is [`amd-ree-mineshaft-phes.md`](amd-ree-mineshaft-phes.md), a verbatim extraction
...
This verb is one of 1 verb in the mining group.
...
| selftest | sentinel only (`module/mineshaft/` directory present) |

To wire this verb: add `verify_mineshaft.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `amd-ree-mineshaft-phes.md`, register the call from
