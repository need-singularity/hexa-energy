# module/arch — arch verb (group: meta)
...
- **Primary spec**: [`energy-architecture.md`](energy-architecture.md)
- **Upstream**: `n6-architecture/domains/energy/energy-architecture/` @ `c0f1f570` (extracted 2026-05-06)

## What's in this module

The primary spec is [`energy-architecture.md`](energy-architecture.md), a verbatim extraction
...
This verb is one of 2 verbs in the meta group.
...
| selftest | sentinel only (`module/arch/` directory present) |

To wire this verb: add `verify_arch.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `energy-architecture.md`, register the call from
