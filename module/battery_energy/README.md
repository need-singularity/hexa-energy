# module/battery_energy — battery_energy verb (group: battery)
...
The primary spec is [`battery-energy.md`](battery-energy.md), a verbatim extraction
...
| working kernel | ☐ TBD (candidate: `verify_battery-energy.hexa`) |
| selftest | sentinel only (`module/battery_energy/` directory present) |

To wire this verb: add `verify_battery_energy.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `battery-energy.md`, register the call from
