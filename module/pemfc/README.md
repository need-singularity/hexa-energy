# module/pemfc — pemfc verb (group: fuel-cell)
...
- **Verb**: `pemfc`
- **Group**: `fuel-cell` (one of 7 — battery / nuclear / grid / fuel-cell / thermal / mining / meta)
- **Primary spec**: [`pemfc.md`](pemfc.md)
- **Upstream**: `n6-architecture/domains/energy/pemfc/` @ `c0f1f570` (extracted 2026-05-06)

## What's in this module

The primary spec is [`pemfc.md`](pemfc.md), a verbatim extraction
...
This verb is one of 1 verb in the fuel-cell group.
...
| selftest | sentinel only (`module/pemfc/` directory present) |

To wire this verb: add `verify_pemfc.{hexa,py}` that auto-derives ≥ 1
quantitative claim from `pemfc.md`, register the call from
